public class Triangle extends Shape2D {
    ...
    public float calculaPerimetro() {
        return super.calculaDistancia(super.getX1(), super.getY1(), super.getX2(), super.getY2())
                + super.calculaDistancia(super.getX1(), super.getY1(), getX3(), getY3())
                + super.calculaDistancia(getX3(), getY3(), super.getX2(), super.getY2());
    }
}