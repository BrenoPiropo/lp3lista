...
public class Data {
    ...
    // Retorna verdadeiro se a data passada por paramentro é anterior a data do
    // objeto
    ...
    public String dayOfWeek(Data date) {
        ...
        int y = date.getYear();
        int k = 0;
        String[] daysWeek = { "Sabado", "Domingo", "Segunda-Feira", "Terça-Feira", "Quarta-Feira", "Quinta-Feira",
                "Sexta-Feira" };
