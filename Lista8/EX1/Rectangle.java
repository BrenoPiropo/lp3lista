public class Rectangle extends Shape2D {
    ...
    public Rectangle(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        ...
        if (!verificaRetangulo()) {
            System.out.println("Não é um retangulo!!");
            System.exit(-1);
        }
    }
    ...
    public float calculaArea() {
        return super.calculaDistancia(getX1(), getY1(), getX2(), getY2())
                * super.calculaDistancia(getX2(), getY2(), getX3(), getY3());
    }

    @Override
    public float calculaPerimetro() {
        return 2 * super.calculaDistancia(super.getX1(), super.getY1(), super.getX2(), super.getY2())
                + 2 * super.calculaDistancia(getX3(), getY3(), getX4(), getY4());
    }
}